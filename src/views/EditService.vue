...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      show: false,
      url: localStorage.getItem('Serthumb_image'),
      url2: null,
      switchVal: true,
      hide: true,
      hide2: true,
      ...
      form: {
        title: localStorage.getItem('SerTitle'),
        description: localStorage.getItem('SerDescription'),
        price: localStorage.getItem('SerPrice'),
        specialties: localStorage.getItem('SerSpecialties'),
        keywords: [localStorage.getItem('SerKeywords')],
        has_file: true,
        attach_file: "",
        images: "",
        url: localStorage.getItem('SerUrl'),
        images: [],
        attach_file: [],
        type_service: true,
        addOnsTitle: "",
        addOnsPrice: "",
        time: localStorage.getItem('SerTime'),
        buyer_instructions: localStorage.getItem('SerInstructions'),
        id: [],
      },
  ...
  mounted() {
    ...
    if(localStorage.getItem('SerUrl')){
      this.type = true
    }


    alert(localStorage.getItem('SerPrice'))
  ...
  methods: {
    ...
    addServise(e) {
      ...
      // alert(this.files)
          ...
          const ServiceID = this.$route.params.mention;
      ...
      dataForm.append("service_id",ServiceID);
      ...
      this.axios
        .post("https://dashboard.arabicreators.com/api/update_service", dataForm, {
          headers: {
